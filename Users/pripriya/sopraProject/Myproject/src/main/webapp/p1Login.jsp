...
<p Style="color:red;">Don't have an account?<span><a href="http://localhost:8080/Myproject/P1reg.jsp" style="text-decoration:none;color:green;"> Sign Up for a Free Trial</a></span></p>
</center>
</form>
</div>
